...
import designpatterns.behavioural.visitor.saglikbankanligi.*;

import java.util.List;

public class CovidIyilesenSayisiVisitor implements Visitor {
    ...
    private int hastaSayisiHesapla(Hastane hastane) {
        ...
        return HastaHesaplaUtil.hastaSayisiHesapla(hastane, EnumHastalik.COVID, EnumHastaDurumu.IYILESTI);
    }
