...
public class CovidZaturreSayisiVisitor implements Visitor {
    ...
    private int hastaSayisiHesapla(Hastane hastane) {
        ...
        return HastaHesaplaUtil.hastaSayisiHesapla(hastane, EnumHastalik.COVID, EnumHastaDurumu.ZATURRE);
    }
